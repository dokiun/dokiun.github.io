const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/magic-eight-ball-CWqQ1Inw.js","assets/three-Cc-ymir6.js","assets/model-viewer-YYf2jdtY.js","assets/three-loaders-BvUUy3pi.js"])))=>i.map(i=>d[i]);
(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function s(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(i){if(i.ep)return;i.ep=!0;const o=s(i);fetch(i.href,o)}})();const E="modulepreload",A=function(e){return"/"+e},u={},h=function(t,s,a){let i=Promise.resolve();if(s&&s.length>0){document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),c=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));i=Promise.allSettled(s.map(n=>{if(n=A(n),n in u)return;u[n]=!0;const l=n.endsWith(".css"),p=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${n}"]${p}`))return;const d=document.createElement("link");if(d.rel=l?"stylesheet":E,l||(d.as="script"),d.crossOrigin="",d.href=n,c&&d.setAttribute("nonce",c),document.head.appendChild(d),l)return new Promise((m,k)=>{d.addEventListener("load",m),d.addEventListener("error",()=>k(new Error(`Unable to preload CSS for ${n}`)))})}))}function o(r){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=r,window.dispatchEvent(c),!c.defaultPrevented)throw r}return i.then(r=>{for(const c of r||[])c.status==="rejected"&&o(c.reason);return t().catch(o)})};function v(){const e=document.createElement("section");return e.className="caja magic-page",e.innerHTML=`
    ...
    `,v.afterRender=()=>{const t=e.querySelector(".magic-viewer"),s=e.querySelector("form"),a=e.querySelector("input"),i=e.querySelector("button"),o=e.querySelector(".magic-answer");let r=!1,c,n=!1;h(async()=>{const{createMagicEightBall:d}=await import("./magic-eight-ball-CWqQ1Inw.js");return{createMagicEightBall:d}},__vite__mapDeps([0,1])).then(({createMagicEightBall:d})=>{r||(c=d(t),i.disabled=!1,i.textContent="Preguntar")}).catch(()=>{r||(o.textContent="No se pudo abrir la bola 3D. Recarga la página para volver a intentarlo.",i.textContent="No disponible")});const l=d=>{if(d.preventDefault(),!(n||!c)){if(!a.value.trim()){a.setCustomValidity("Escribe una pregunta primero."),a.reportValidity();return}n=!0,i.disabled=!0,i.textContent="Consultando…",o.textContent="Gabriela está consultando al universo…",t.setAttribute("aria-busy","true"),c.ask(m=>{r||(n=!1,i.disabled=!1,i.textContent="Preguntar otra vez",o.textContent=m,t.setAttribute("aria-busy","false"))})}},p=()=>a.setCustomValidity("");return a.addEventListener("input",p),s.addEventListener("submit",l),()=>{r=!0,c==null||c.dispose(),a.removeEventListener("input",p),s.removeEventListener("submit",l)}},e}function S(){const e=document.createElement("div");return e.innerHTML=`
      <!-- Spotify -->
...
<p>&nbsp;</p>
    ...
    `,e}function q(){const e=document.createElement("div");return e.innerHTML=`
...
<div class="caja"> <!-- Debug -->
    ...
    `,e}function _(){const e=document.createElement("div");return e.innerHTML=`
    <div class="caja">
      <div class="title">
    ...
    `,e}_.afterRender=()=>{const e=document.getElementById("viewer3d"),t=document.getElementById("model-selector");if(e){let s=[],a,i;const o=()=>{if(!a)return;i&&i();const n=s.find(l=>l.id===t.value);n&&(i=a.initModelViewer(e,n))};t.addEventListener("change",o);const r=fetch("/models/models.json").then(n=>{if(!n.ok)throw new Error("No se pudo cargar el catálogo de modelos");return n.json()}).then(n=>{if(s=n,t.replaceChildren(...s.map(l=>{const p=document.createElement("option");return p.value=l.id,p.textContent=l.label,p})),t.disabled=s.length===0,s.length===0)throw new Error("No hay pares OBJ y MTL disponibles");t.value=(s.find(l=>l.id==="Lanzador")||s[0]).id}),c=new IntersectionObserver(n=>{n.forEach(l=>{l.isIntersecting&&(Promise.all([h(()=>import("./model-viewer-YYf2jdtY.js"),__vite__mapDeps([2,1,3])),r]).then(([p])=>{a=p,o()}).catch(p=>{console.error("Error al cargar el modelo 3D:",p),e.innerHTML=`
                <div style="
                  display: flex; 
                  align-items: center; 
...
<div class="faq-container">
    ...
    `,f.afterRender=()=>w(e),e}function L(){const e=document.querySelector(".main-item"),t=document.querySelector(".accordion-container > ul");if(e&&t){e.setAttribute("role","button"),e.setAttribute("tabindex","0"),e.setAttribute("aria-expanded","false");const s=()=>{const a=e.classList.toggle("main-item--open");e.setAttribute("aria-expanded",String(a))};e.addEventListener("click",()=>{s()}),e.addEventListener("keydown",a=>{(a.key==="Enter"||a.key===" ")&&(a.preventDefault(),s())}),t.addEventListener("click",a=>{a.target.closest("a")&&b()})}}function b(){const e=document.querySelector(".main-item");e&&(e.classList.remove("main-item--open"),e.setAttribute("aria-expanded","false"))}const j=Object.assign({"./pages/Gabriela.js":v,"./pages/about.js":S,"./pages/blog.js":q,"./pages/home.js":_,"./pages/proyectos.js":f}),y=Object.fromEntries(Object.entries(j).map(([e,t])=>{const s=e.split("/").pop().replace(".js","");return[s==="home"?"/":`/${s}`,t]}));function M(e){return e==="/"?"Inicio":e.slice(1).replace(/[-_]+/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function z(){const e=document.querySelectorAll("[data-navigation]"),t=Object.keys(y).sort((s,a)=>s==="/"?-1:a==="/"?1:s.localeCompare(a));e.forEach(s=>{s.replaceChildren(...t.map(a=>{const i=document.createElement("li"),o=document.createElement("a");return o.href=`#${a}`,o.dataset.link=a,o.textContent=M(a),i.appendChild(o),i}))})}let g;function x(){typeof g=="function"&&g(),g=void 0;const e=location.hash.slice(1)||"/",t=document.getElementById("app"),s=y[e];if(s){t.innerHTML="";const a=s();t.appendChild(a),typeof s.afterRender=="function"&&(g=s.afterRender()),z(),P(),b()}else t.innerHTML="<h2>Página no encontrada</h2>"}function P(){const e=document.querySelectorAll("nav a[data-link]"),t=location.hash.slice(1)||"/";e.forEach(s=>{s.getAttribute("data-link")===t?s.classList.add("active"):s.classList.remove("active")})}function D(){L()}window.addEventListener("hashchange",x);window.addEventListener("load",x);window.addEventListener("DOMContentLoaded",()=>{D(),"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("/sw.js").then(e=>{console.log("🔧 Service Worker registrado:",e.scope)}).catch(e=>{console.log("❌ Error al registrar Service Worker:",e)})})});
