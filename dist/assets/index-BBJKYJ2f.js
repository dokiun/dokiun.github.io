(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))l(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&l(a)}).observe(document,{childList:!0,subtree:!0});function t(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function l(s){if(s.ep)return;s.ep=!0;const o=t(s);fetch(s.href,o)}})();const h="modulepreload",w=function(e){return"/"+e},p={},b=function(i,t,l){let s=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),r=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));s=Promise.allSettled(t.map(c=>{if(c=w(c),c in p)return;p[c]=!0;const n=c.endsWith(".css"),u=n?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${u}`))return;const d=document.createElement("link");if(d.rel=n?"stylesheet":h,n||(d.as="script"),d.crossOrigin="",d.href=c,r&&d.setAttribute("nonce",r),document.head.appendChild(d),n)return new Promise((_,v)=>{d.addEventListener("load",_),d.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${c}`)))})}))}function o(a){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=a,window.dispatchEvent(r),!r.defaultPrevented)throw a}return s.then(a=>{for(const r of a||[])r.status==="rejected"&&o(r.reason);return i().catch(o)})};function g(){const e=document.createElement("div");return e.innerHTML=`
    ...
    `,e}g.afterRender=()=>{const e=document.getElementById("viewer3d");e&&b(()=>import("./model-viewer-ClFR6lzd.js"),[]).then(i=>{i.initModelViewer(e)})};function f(){const e=document.createElement("div");return e.innerHTML=`
      <!-- Spotify -->
...
<script src="scriptacordeon.js"><\/script>
    `,e}const x={"/":g,"/about":f,"/blog":y,"/proyectos":k};function m(){const e=location.hash.slice(1)||"/",i=document.getElementById("app"),t=x[e];if(t){i.innerHTML="";const l=t();i.appendChild(l),typeof t.afterRender=="function"&&t.afterRender(),S()}else i.innerHTML="<h2>Página no encontrada</h2>"}function S(){const e=document.querySelectorAll("nav a[data-link]"),i=location.hash.slice(1)||"/";e.forEach(t=>{t.getAttribute("data-link")===i?t.classList.add("active"):t.classList.remove("active")})}window.addEventListener("hashchange",m);window.addEventListener("load",m);
